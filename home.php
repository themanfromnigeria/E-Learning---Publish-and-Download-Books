...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      ...
      <!-- <form action="search.php" method="get" class="form-inline ml-0 ml-md-3">
          <div class="input-group input-group-sm">
            <input class="form-control form-control-navbar" type="text" name="key" placeholder="Search  for Books" aria-label="Search">
...
<section class="home">
   ...
   <div class="content">
      <h3>Welcome to Lead City E-Learning Center</h3>
      <p>View Books are available for you to download</p>
   </div>
</section>
    <br>
<br>
