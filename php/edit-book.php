		      ...
		      if (!empty($_FILES['file']['name'])) {
				...
				**/
		        if ($book_cover['status'] == "error" || 
			    	...
			    	/**
			    	  Redirect to '../admin/edit-book.php' 
			    	  and passing error message & the id
			    	**/
			    	header("Location: ../admin/edit-book.php?error=$em&id=$id");
			    	exit;
			    }else {
                  # current book cover path
			      $c_p_book_cover = "../admin/uploads/cover/$current_cover";

			      # current file path
			      $c_p_file = "../admin/uploads/files/$current_file";
		          ...
		          **/
				    ...
				    **/
				     if ($res) {
						...
						header("Location: ../admin/edit-book.php?success=$sm&id=$id");
			            exit;
				     }else{
				     	# Error message
