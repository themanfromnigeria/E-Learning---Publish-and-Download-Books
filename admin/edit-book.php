        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="admin.php">View Books</a></li>
		...
		<?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <option value="0">Choose Author</option>
                        <?php 
                        if ($authors == 0) {
                            //if no author in db, nothing happens
                        }else{
                            //loop through the authors in db
                    ...
                    <div class="form-group">
                        ...
                        <a href="../uploads/cover/<?=$book['cover']?>" class="link-dark">View Current Cover</a>
                    </div>
                    <div class="form-group">
